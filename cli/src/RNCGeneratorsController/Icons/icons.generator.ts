import { IIconsGenerator } from './types'
import { inject, injectable } from 'inversify'
import {
  ISpacingPropsModule,
  SpacingPropsModuleId,
} from '../../RNCModulesController/Modules/SpacingPropsModule'
...
import { ICON_COMPONENT_FILE_TEMPLATE } from './templates'

export const IconsGeneratorId = Symbol.for('IconsGeneratorId')

@injectable()
export class IconsGenerator implements IIconsGenerator {
  constructor(
