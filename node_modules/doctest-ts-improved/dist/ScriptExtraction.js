...
exports.ScriptExtraction = void 0;
...
class ScriptExtraction {
     ...
     * m[1] // => ' true'
     */
    static doctest_rhs(s) {
        return s.match(/^\s*\/\/[ \t]*=>([^\n]*)/m);
    }
    static extractImports(docstring) {
     ...
     */
    static extractScripts(docstring) {
        const out = [];
        function lineIndexOf(part) {
     ...
     */
    static extractScript(s, linestart) {
...
exports.ScriptExtraction = ScriptExtraction;
